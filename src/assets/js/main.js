...
$(document).ready(function () {
    ...
    /*==============================================================*/
    var $buythemediv = '<div class="buy-theme alt-font md-display-none"><a href="https://toflabs.com" target="_blank"><i class="fa fa-phone"></i><span>03124173289</span></a></div><div class="all-demo alt-font md-display-none"><a href="mailto:sanatyazkisiselgelisim@gmail.com?subject=Sisteminiz İçin Bir Öneri/Talebim var. (sanatyaz.com)"><i class="fas fa-envelope"></i></i><span>ÖNERİ VE TALEP ?</span></a></div>';
